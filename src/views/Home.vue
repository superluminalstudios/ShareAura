				...
				<div class="fixed-search">
					<div class="search-wrapper">
						...
						<form @submit.prevent="goToSearch">
							<input v-model="userSearchInput" type="text" placeholder="Search for Books, Stationaries" class="search-input" />
						</form>
					</div>
				</div>
					...
					<div class="create-wrapper">
						...
						<div class="create-post-body">
							...
							<h3 class="create-subtitle">
								Need a textbook or want to clarify doubts? Make a request and source it from the community.
							</h3>
						</div>
						<div class="create-buttons">
							<div class="create-button" @click="() => router.push('/AddRequest')">Request Books</div>
							<div class="cat-line"></div>
							<div class="create-button" @click="() => router.push('/AddQuestion')">Ask Questions</div>
						</div>
					</div>
					<div class="title-group-1">
