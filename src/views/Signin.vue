      ...
      <div class="signup-wrapper">
        ...
        <div class="signup-lower">
          ...
          <div class="signup-inputs">
            ...
            <div class="signin-input-wrapper marg">
              <input
                type="password"
                v-model="password"
          ...
          <div class="sign-wrapper" @click="authApi">
            ...
            <h3 class="sign-in">
              ...
              <span class="underline" @click="() => router.push('/signup')"
                >Sign Up
              </span>
            </h3>
          </div>
...
const storeUserData = async () => {
    ...
    function authApi() {
      try {
        axios
          .get(
            `https://staiauthapi.jeswinsunsi.repl.co/signin/${phone.value}/${password.value}`
          )
          .then((data) => {
